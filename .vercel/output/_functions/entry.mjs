...
var middlewareSecret = "f7e3edf5-ca34-41ee-be69-fc5769ca69ce";
//#endregion
...
var _page1 = () => import("./chunks/contact_CfQmxE5R.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "f7e3edf5-ca34-41ee-be69-fc5769ca69ce") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
