import { $ as NoImageMetadata, Z as MissingSharp, _t as AstroError, ht as UnsupportedImageFormat, y as detector } from "./path_Cwk3cB56.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_CvgE1f0b.mjs";
//#region node_modules/.pnpm/astro@7.2.9_@emnapi+core@1.11.1_@emnapi+runtime@1.11.1_@types+node@24.13.4_@vercel+functions@3.9.5_jiti@2.7.0/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_CNt6SyNN.mjs")).default;
	} catch {
